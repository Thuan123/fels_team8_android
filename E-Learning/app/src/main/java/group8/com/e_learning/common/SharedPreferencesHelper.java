...
public class SharedPreferencesHelper {
    ...
    {
        SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("UserInfo",0);
    ...
    {
        SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("UserInfo", Context.MODE_PRIVATE);
        return sharedPreferences.getString("user1_email", "");
    }
    ...
    {
        SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("UserInfo", Context.MODE_PRIVATE);
        return sharedPreferences.getString("user2_email","");
    }
    ...
    {
        SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("UserInfo", Context.MODE_PRIVATE);
        return sharedPreferences.getString("user1_pass","");
    }
    ...
    {
        SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("UserInfo", Context.MODE_PRIVATE);
        return sharedPreferences.getString("user2_pass","");
    }
    ...
    {
        SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("UserInfo", Context.MODE_PRIVATE);
        return sharedPreferences.getString("user1_name","");
    }
    ...
    {
        SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("UserInfo", Context.MODE_PRIVATE);
        return sharedPreferences.getString("user2_name","");
    }
       ...
       /* public boolean getCheckLogin() {
        ...
        public boolean getCheckIntrusion() {
            SharedPreferences preferences = Constant.context.getSharedPreferences("CheckInstrusion", Context.MODE_PRIVATE);
        ...
        public void setWifiList(String key, ArrayList<String> wifiList) {
            SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("WifiInfo", Context.MODE_PRIVATE);
            SharedPreferences.Editor user = sharedPreferences.edit();
        ...
        public ArrayList<String> getWifiList(String key) {
            SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("WifiInfo", Context.MODE_PRIVATE);
            Set<String> wifiSet = sharedPreferences.getStringSet(key, "");
        ...
        public void setGpsCheck(String key, boolean state) {
            SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("GpsInfo", Context.MODE_PRIVATE);
            SharedPreferences.Editor user = sharedPreferences.edit();
            user.putBoolean(key, state);
            user.apply();
        }
        ...
        {
            SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("GpsInfo", 0);
            SharedPreferences.Editor user = sharedPreferences.edit();
        ...
        {
            SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("StopSend", 0);
            SharedPreferences.Editor user = sharedPreferences.edit();
        ...
        public void setDatabaseVersion(int version) {
            SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("AppInfo", 0);
            SharedPreferences.Editor user = sharedPreferences.edit();
        ...
        {
            SharedPreferences sharedPreferences = Constant.context.getSharedPreferences("reply", 0);
            SharedPreferences.Editor user = sharedPreferences.edit();
